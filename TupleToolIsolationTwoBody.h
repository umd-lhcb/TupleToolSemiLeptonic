 ...
 *
 *  @author Fatima Soomro, based on the code by Giampiero Mancinelli
 * giampi@cppm.in2p3.fr in DaVinciTools
 *  @date   2012-03-17
 */
class TupleToolIsolationTwoBody : public TupleToolBase,
 ...
 public:
  ...
  TupleToolIsolationTwoBody(const std::string& type, const std::string& name,
 ...
 private:
   ...
   *  @param iso      (output) number(s) of non-isolating particles (2
   * isolations)
   *  @param massiso      (output) invariant mass of non-isolating particles
   *  @param chi2iso      (output) chi2 of particle made with non-isolating
   * particles
  ...
  StatusCode MuChi2(const LHCb::Particle* P, const std::string& head,
                    Tuples::Tuple& tuple);

  /** Defines whether or not a particle is not isolating according to the
      BsMuMu Roadmap, using an Hlt criterium
  */
  void IsHltGood(Gaudi::XYZPoint o, Gaudi::XYZVector p, Gaudi::XYZPoint o_mu,
                 Gaudi::XYZVector p_mu, Gaudi::XYZPoint PV, int& hltgood,
                 double& fc) const;
  ...
  */
  void InCone(Gaudi::XYZPoint o1, Gaudi::XYZVector p1, Gaudi::XYZPoint o2,
              Gaudi::XYZVector p2, Gaudi::XYZPoint& vtx, double& doca,
              double& angle) const;
   ...
   */
  double pointer(Gaudi::XYZVector vtx, Gaudi::XYZVector P_tr,
   ...
   */
  void closest_point(Gaudi::XYZPoint o, Gaudi::XYZVector p,
