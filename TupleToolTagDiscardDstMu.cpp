...
StatusCode TupleToolTagDiscardDstMu::fill(const Particle* mother, const Particle* P, const std::string& head, Tuples::Tuple& tuple)
{

    const std::string prefix = fullName(head);
    Assert(P && mother && m_dist, "This should not happen, you are inside TupleToolTagDiscardDstMu.cpp :(");
...
//
//=========================================================================
const Vertex* TupleToolTagDiscardDstMu::originVertex(const Particle* top, const Particle* P) const
{
