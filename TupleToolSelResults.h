 ...
 * @endcode
 *
 * Warning : It will create fields "Hlt2", "Hlt2", "MySelection" in the Tuple.
...
class TupleToolSelResults : public TupleToolBase,
                            virtual public IEventTupleTool {
 public:
  /// Standard constructor
  TupleToolSelResults(const std::string& type, const std::string& name,
