#ifndef TupleToolTauMuDiscrVars_RJpsi_H
#define TupleToolTauMuDiscrVars_RJpsi_H 1
...
/**
 * @class TupleToolTauMuDiscrVars_RJpsi TupleToolTauMuDiscrVars_RJpsi.h
 ...
 * - head_ENDVERTEX_[X|Y|Z]ERR : decay vertex position error estimate for
 * composite particles
 ...
 * - head_OWNPV_[X|Y|Z]ERR : related primary vertex position error estimate for
 * composite particles
 * - head_OWNPV_CHI2 : related primary vertex chi2
 * - head_OWNPV_NDOF : related primary vertex nDoF
 * - head_IP_OWNPV : impact parameter with respect to the
 * PhysDesktop::relatedVertex() considered particle
 * - head_IPCHI2_OWNPV : impact parameter chi2 with respect to the
 * relatedVertex() considered particle
 * - head_FD_OWNPV : flight distance of composite particle wrt. the
 * relatedVertex() considered particle
 * - head_FDCHI2_OWNPV : flight distance significance in units of chi2 wrt. the
 * relatedVertex() considered particle
 * - head_DIRA_OWNPV : direction angle wrt. the PhysDesktop::relatedVertex()
 * considered particle
 *
 *  If Verbose is true:
 *
 ...
 * chi2
 * - head_TOPPV_NDOF : PhysDesktop::relatedVertex() of the top of decay chain
 * nDoF
 * - head_IP_TOPPV : impact parameter with respect to the
 * PhysDesktop::relatedVertex() of the top of decay chain
 * - head_IPCHI2_TOPPV : impact parameter chi2 with respect to the
 * relatedVertex() of the top of decay chain
 * - head_FD_TOPPV : flight distance of composite particle wrt. the
 * relatedVertex() of the top of decay chain
 ...
 * - head_DIRA_TOPPV : direction angle wrt. the relatedVertex() of the top of
 * decay chain
 *
 * - head_ORIVX_[X|Y|Z] : ancestor's related primary vertex position (when
 * applicable)
 * - head_ORIVX_[X|Y|Z]ERR : ancestor's related primary vertex position error
 ...
 * - head_IP_ORIVX : impact parameter with respect to the ancestor's vertex
 * (when applicable)
 * - head_IPCHI2_ORIVX : impact parameter chi2 with respect to the ancestor's
 * vertex (when applicable)
 * - head_FD_ORIVX : flight distance of composite particle wrt. the ancestor's
 * vertex (when applicable)
 * - head_FDCHI2_ORIVX : flight distance significance in units of chi2 wrt.
 * ancestor's vertex (when applicable)
 ...
 * @date   2019-11-11
 */
class TupleToolTauMuDiscrVars_RJpsi : public TupleToolBase,
                                virtual public IParticleTupleTool {
 public:
  TupleToolTauMuDiscrVars_RJpsi( const std::string& type, const std::string& name,
                           const IInterface* parent );

  ~TupleToolTauMuDiscrVars_RJpsi() override = default;
...
#endif  // TupleToolTauMuDiscrVars_RJpsi_H
