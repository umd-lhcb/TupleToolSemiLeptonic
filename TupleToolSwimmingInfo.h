 ...
 *  @data   2011-10-15
 */
class TupleToolSwimmingInfo : public TupleToolBase,
                              virtual public IParticleTupleTool {
 public:
  /// Standard constructor
  TupleToolSwimmingInfo(const std::string& type, const std::string& name,
 ...
 private:
  ...
  bool getRelationsFromDescendant(P2TPRelation::Range& range,
                                  const P2TPRelation* relateParts,
                                  const LHCb::Particle* Phead,
