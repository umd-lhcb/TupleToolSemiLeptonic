 ...
 *----- The association is done via the relation table between the ProtoParticle
 *and the MC
...
//============================================================================
class TupleToolPi0Info : public TupleToolBase,
                         virtual public IParticleTupleTool {
  //==========================================================================
 public:
  // Standard constructor
  TupleToolPi0Info(const std::string& type, const std::string& name,
 ...
 private:
  ...
  const LHCb::MCParticle* getMCGamma(const LHCb::Particle* part,
                                     double& weight);
  typedef IRelationWeighted<LHCb::ProtoParticle, LHCb::MCParticle, double>
      mcTable;
