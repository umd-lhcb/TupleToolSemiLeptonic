...
/** @class TupleToolPropertime TupleToolPropertime.h
 * jborel/TupleToolPropertime.h \brief Fills the propertime for DecayTreeTuple
 *
 * Columns filled:
 * - head_TAU
 * - head_TAUERR
...
class TupleToolPropertime : public TupleToolBase,
 ...
 public:
  ...
  TupleToolPropertime(const std::string& type, const std::string& name,
