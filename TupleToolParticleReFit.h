...
/** @class TupleToolParticleReFit TupleToolParticleReFit.h
 * jborel/TupleToolParticleReFit.h \brief Use a standard vertex fitter to refit
 * head of a decay chain and fill DecayTreeTuple
 *
 * Columns filled:
 * - head_OVrefit_status
 ...
 * tuple.TupleToolParticleReFit.OfflineVertexFitter.applyDauMassConstraint =
 * True
 *
 * Example 2: refit in order to get rid of already applied daughter mass
 * cosntraint
...
class TupleToolParticleReFit : public TupleToolBase,
 ...
 public:
  ...
  TupleToolParticleReFit(const std::string& type, const std::string& name,
