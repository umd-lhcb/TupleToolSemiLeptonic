...
//  usage :
//
//  mytuple.Particle="name"       # the specific particle to be checked (default
//  : all maked DecayTreeTuple::DecayDescriptor particles)
//  mytuple.TupleToolVeto[VetoName].["Container1","Container2",...]  # list of
//  containers to be checked
//
//
//  e.g.:
//   - pi0-Veto for single photon  : flag all photons which are already used to
//   build a pi0 as defined in StdLooseResolvedPi0
//      mytuple.TupleToolVeto.Particle="gamma"
//      mytuple.TupleToolVeto.Veto[Pi0R]=["/Event/Phys/StdLooseResolvedPi0/Particles"]
//
//   - pi0-veto for pi0 :  flag all pi0 which are not exclusive with respect to
//   **other** pi0's
//      mytuple.TupleToolVeto.Particle="pi0"
//      mytuple.TupleToolVeto.VetoOther[Pi0R]=["/Event/Phys/StdLooseResolvedPi0/Particles"]
//
//      -> the overlap of the pi0 with itself is not considered (property
//      VetoOther) - only partial overlap are checked
//
//   - works for any (composite or basic) particle. Relies on tool
//   DaVinciTools/ParticleVeto  (see doxygen for details)
//
//
//-----------------------------------------------------------------------------
...
//=============================================================================
TupleToolVeto::TupleToolVeto(const std::string& type, const std::string& name,
                             const IInterface* parent)
    : TupleToolBase(type, name, parent), m_pid(0) {
