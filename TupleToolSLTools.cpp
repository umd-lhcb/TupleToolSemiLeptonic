...
StatusCode TupleToolSLTools::fill(const Particle* mother, const Particle* P,
  ...
  */
  ...
  std::vector<double> q2_err =
      q2_errors(TV3_SV, TV3_PV, TLV_P, TLV_mu, P->covMatrix(), PV->covMatrix());
...
std::vector<TLorentzVector> TupleToolSLTools::recoNu(TLorentzVector Y,
  ...
  p_nu.push_back(TLorentzVector(P_nu_recon_3V1,
                                sqrt(p1nu * p1nu + Ppmu.Py() * Ppmu.Py())));
  p_nu.push_back(TLorentzVector(P_nu_recon_3V2,
                                sqrt(p2nu * p2nu + Ppmu.Py() * Ppmu.Py())));
  return p_nu;
}

std::vector<double> TupleToolSLTools::Mcorr_errors(TVector3 v1, TVector3 v2,
                                                   TLorentzVector p,
  ...
  double dMcdpx =
      (2 *
           ...
           (px - ((x - xp) * (px * (x - xp) + py * (y - yp) + pz * (z - zp))) /
                     (pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2))) -
       (2 * (x - xp) * (y - yp) *
        (py - ((y - yp) * (px * (x - xp) + py * (y - yp) + pz * (z - zp))) /
                  (pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2)))) /
           (pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2)) -
       (2 * (x - xp) *
        (pz - ((px * (x - xp) + py * (y - yp) + pz * (z - zp)) * (z - zp)) /
                  (pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2))) *
        (z - zp)) /
           (pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2))) /
          (2. *
      ...
      (-2 * px +
       ...
       (2 * (x - xp) *
        ...
        (z - zp)) /
           (pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2))) /
          (2. *
           sqrt(pow(k, 2) - pow(px, 2) - pow(py, 2) - pow(pz, 2) +
                pow(px - ((x - xp) *
                          (px * (x - xp) + py * (y - yp) + pz * (z - zp))) /
                             (pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2)),
                    2) +
  ...
  double dMcdE =
      k / sqrt(pow(k, 2) - pow(px, 2) - pow(py, 2) - pow(pz, 2) +
               pow(px - ((x - xp) *
                         (px * (x - xp) + py * (y - yp) + pz * (z - zp))) /
                            (pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2)),
                   2) +
                      ...
                      (pz - ((px * (x - xp) + py * (y - yp) + pz * (z - zp)) *
                             (z - zp)) /
                                (pow(x - xp, 2) + pow(y - yp, 2) +
                                 pow(z - zp, 2)))) /
                     (2. *
                      sqrt(pow(px - ((x - xp) * (px * (x - xp) + py * (y - yp) +
                                                 pz * (z - zp))) /
                                        (pow(x - xp, 2) + pow(y - yp, 2) +
                                         pow(z - zp, 2)),
                               2) +
  ...
  double dMcdz =
      (2 *
           ...
           (-((pz * (x - xp)) /
              (pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2))) +
            (2 * (x - xp) * (px * (x - xp) + py * (y - yp) + pz * (z - zp)) *
             (z - zp)) /
                pow(pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2), 2)) +
       2 *
           (py - ((y - yp) * (px * (x - xp) + py * (y - yp) + pz * (z - zp))) /
                     (pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2))) *
           (-((pz * (y - yp)) /
              (pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2))) +
            (2 * (y - yp) * (px * (x - xp) + py * (y - yp) + pz * (z - zp)) *
             (z - zp)) /
                pow(pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2), 2)) +
       2 *
           (pz - ((px * (x - xp) + py * (y - yp) + pz * (z - zp)) * (z - zp)) /
           ...
           2 *
               ((-2 * (x - xp) * (y - yp) *
                ...
                (px * (y - yp)) /
                    (pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2))) *
               (py -
                ((y - yp) * (px * (x - xp) + py * (y - yp) + pz * (z - zp))) /
                    (pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2))) +
           2 *
               ((-2 * (x - xp) *
                 (px * (x - xp) + py * (y - yp) + pz * (z - zp)) * (z - zp)) /
                    pow(pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2), 2) +
                (px * (z - zp)) /
                    (pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2))) *
               (pz -
                ((px * (x - xp) + py * (y - yp) + pz * (z - zp)) * (z - zp)) /
                    (pow(x - xp, 2) + pow(y - yp, 2) + pow(z - zp, 2)))) /
              (2. * sqrt(pow(px - ((x - xp) * (px * (x - xp) + py * (y - yp) +
                                               pz * (z - zp))) /
                                      (pow(x - xp, 2) + pow(y - yp, 2) +
                                       pow(z - zp, 2)),
                             2) +
  ...
  double vertex_errsq =
      ...
      2. * dMcdxp * dMcdzp * cov2(0, 2) + 2. * dMcdyp * dMcdzp * cov2(1, 2);
  ...
  double momentum_errsq =
      ...
      +2. * dMcdpx * dMcdpy * cov1(3, 4) + 2. * dMcdpx * dMcdpz * cov1(3, 5) +
      2. * dMcdpx * dMcdE * cov1(3, 6) + 2. * dMcdpy * dMcdpz * cov1(4, 5) +
...
double TupleToolSLTools::dpnulowdpperp(double pperp, TLorentzVector visible) {
  ...
  double result =
      (2 * pperp +
       ((-16 * pmag * pperp * sqrt(1 - pow(pperp, 2) / pow(pmag, 2)) +
         ...
         (16 * pperp *
          ((pow(mmiss, 2) + pow(mvis, 2)) * (pow(pmag, 2) - 2 * pow(pperp, 2)) +
           pow(mBmass, 2) * (pow(mvis, 2) + 2 * pow(pperp, 2)))) /
             sqrt(pow(mmiss, 4) * (pow(mvis, 2) + pow(pmag, 2)) +
                  pow(mmiss, 2) *
                      (-4 * pow(pmag, 2) * pow(pperp, 2) + 4 * pow(pperp, 4)) -
                  4 * pow(pperp, 2) *
                      (pow(mvis, 2) * (pow(pmag, 2) - pow(pperp, 2)) +
                       pow(mBmass, 2) * (pow(mvis, 2) + pow(pperp, 2))))) *
       ...
       (pperp *
        pow(-(pow(mmiss, 2) * pmag * sqrt(1 - pow(pperp, 2) / pow(pmag, 2))) +
                2 * pmag * pow(pperp, 2) *
                    sqrt(1 - pow(pperp, 2) / pow(pmag, 2)) +
                sqrt(pow(mmiss, 4) * (pow(mvis, 2) + pow(pmag, 2)) +
                     pow(mmiss, 2) * (-4 * pow(pmag, 2) * pow(pperp, 2) +
                                      4 * pow(pperp, 4)) -
                     4 * pow(pperp, 2) *
                         (pow(mvis, 2) * (pow(pmag, 2) - pow(pperp, 2)) +
                          pow(mBmass, 2) * (pow(mvis, 2) + pow(pperp, 2)))),
...
double TupleToolSLTools::dpnuhighdpperp(double pperp, TLorentzVector visible) {
  double pmag = visible.P();
  double mBmass = m_Bmass;
  double mvis = visible.M();
  double mmiss = sqrt(mBmass * mBmass - mvis * mvis);
  double result =
      (64 * pperp -
       (32 * pperp *
        pow(-(pow(mmiss, 2) * sqrt(pow(pmag, 2) - pow(pperp, 2))) +
                2 * pow(pperp, 2) * sqrt(pow(pmag, 2) - pow(pperp, 2)) +
                sqrt(pow(pow(mmiss, 2) - 2 * pow(pperp, 2), 2) *
                         (pow(pmag, 2) - pow(pperp, 2)) +
                     (pow(mvis, 2) + pow(pperp, 2)) *
                         (-pow(mmiss, 4) +
                          4 * pow(pperp, 2) *
                              (pow(mBmass, 2) + pow(pmag, 2) - pow(pperp, 2)))),
            2)) /
           pow(pow(mvis, 2) + pow(pperp, 2), 3) +
       ((-4 * sqrt(pow(pmag, 2) - pow(pperp, 2)) *
        ...
        (-16 * pperp * sqrt(pow(pmag, 2) - pow(pperp, 2)) +
         ...
         (8 * pperp *
          (pow(mmiss, 4) +
           2 * pow(mmiss, 2) * (pow(pmag, 2) - 2 * pow(pperp, 2)) -
           2 * (4 * pow(pmag, 2) * pow(pperp, 2) - 6 * pow(pperp, 4) +
                pow(mvis, 2) * (pow(pmag, 2) - 2 * pow(pperp, 2)) +
                pow(mBmass, 2) * (pow(mvis, 2) + 2 * pow(pperp, 2))))) /
             sqrt(pow(pow(mmiss, 2) - 2 * pow(pperp, 2), 2) *
                      (pow(pmag, 2) - pow(pperp, 2)) +
                  (pow(mvis, 2) + pow(pperp, 2)) *
...
std::vector<double> TupleToolSLTools::q2_errors(TVector3 v1, TVector3 v2,
  ...
  double dpperpdx =
      (-(((2 * x - 2 * xp) *
          (pow(pz, 2) * (pow(x, 2) - 2 * x * xp + pow(xp, 2) + pow(y - yp, 2)) -
           2 * py * (y - yp) * (px * (x - xp) + pz * (z - zp)) +
           pow(py, 2) * (pow(x, 2) - 2 * x * xp + pow(xp, 2) + pow(z - zp, 2)) +
           pow(px, 2) * (pow(y, 2) - 2 * y * yp + pow(yp, 2) + pow(z - zp, 2)) -
           2 * px * pz * (x - xp) * (z - zp))) /
         pow(pow(x, 2) - 2 * x * xp + pow(xp, 2) + pow(y, 2) - 2 * y * yp +
                 pow(yp, 2) + pow(z, 2) - 2 * z * zp + pow(zp, 2),
             2)) +
       (pow(py, 2) * (2 * x - 2 * xp) + pow(pz, 2) * (2 * x - 2 * xp) -
        2 * px * py * (y - yp) - 2 * px * pz * (z - zp)) /
           (pow(x, 2) - 2 * x * xp + pow(xp, 2) + pow(y, 2) - 2 * y * yp +
            pow(yp, 2) + pow(z, 2) - 2 * z * zp + pow(zp, 2))) /
      (2. * sqrt((pow(pz, 2) *
                      (pow(x, 2) - 2 * x * xp + pow(xp, 2) + pow(y - yp, 2)) -
                  2 * py * (y - yp) * (px * (x - xp) + pz * (z - zp)) +
                  pow(py, 2) *
                      (pow(x, 2) - 2 * x * xp + pow(xp, 2) + pow(z - zp, 2)) +
                  pow(px, 2) *
                      (pow(y, 2) - 2 * y * yp + pow(yp, 2) + pow(z - zp, 2)) -
                  2 * px * pz * (x - xp) * (z - zp)) /
                 (pow(x, 2) - 2 * x * xp + pow(xp, 2) + pow(y, 2) - 2 * y * yp +
                  pow(yp, 2) + pow(z, 2) - 2 * z * zp + pow(zp, 2))));
  double dpperpdy =
  ...
  double q2err_low =
      cov1(0, 0) * dq2lowdx * dq2lowdx + cov1(1, 1) * dq2lowdy * dq2lowdy +
      cov1(2, 2) * dq2lowdz * dq2lowdz + cov2(0, 0) * dq2lowdxp * dq2lowdxp +
      cov2(1, 1) * dq2lowdyp * dq2lowdyp + cov2(2, 2) * dq2lowdzp * dq2lowdzp +
