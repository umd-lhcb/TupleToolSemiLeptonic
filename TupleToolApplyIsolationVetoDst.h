 ...
 *  @date   2008-04-15
 */
class TupleToolApplyIsolationVetoDst : public TupleToolBase, virtual public IParticleTupleTool {
public:
...
private:
    ...
    void writeParticle(const LHCb::Particle* P, double bdt, std::string name, Tuples::Tuple& tuple, std::string prefix, const LHCb::Particle* Mother);
    IDVAlgorithm* m_dva;
